...
This guide provides comprehensive documentation for the **go-database** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-database - [your task description]"

# Example
claude "go-database - analyze the current implementation"
```
...
def implement_go_database(input_data):
    """
    Implement go-database functionality.
