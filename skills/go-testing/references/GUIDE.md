...
This guide provides comprehensive documentation for the **go-testing** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-testing - [your task description]"

# Example
claude "go-testing - analyze the current implementation"
```
...
def implement_go_testing(input_data):
    """
    Implement go-testing functionality.
