...
This guide provides comprehensive documentation for the **go-modules** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-modules - [your task description]"

# Example
claude "go-modules - analyze the current implementation"
```
...
def implement_go_modules(input_data):
    """
    Implement go-modules functionality.
