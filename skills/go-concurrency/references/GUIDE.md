...
This guide provides comprehensive documentation for the **go-concurrency** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-concurrency - [your task description]"

# Example
claude "go-concurrency - analyze the current implementation"
```
...
def implement_go_concurrency(input_data):
    """
    Implement go-concurrency functionality.
