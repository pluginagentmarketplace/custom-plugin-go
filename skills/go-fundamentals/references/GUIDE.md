...
This guide provides comprehensive documentation for the **go-fundamentals** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-fundamentals - [your task description]"

# Example
claude "go-fundamentals - analyze the current implementation"
```
...
def implement_go_fundamentals(input_data):
    """
    Implement go-fundamentals functionality.
