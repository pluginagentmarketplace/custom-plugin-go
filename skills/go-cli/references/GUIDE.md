...
This guide provides comprehensive documentation for the **go-cli** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-cli - [your task description]"

# Example
claude "go-cli - analyze the current implementation"
```
...
def implement_go_cli(input_data):
    """
    Implement go-cli functionality.
