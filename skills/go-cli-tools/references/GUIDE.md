...
This guide provides comprehensive documentation for the **go-cli-tools** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-cli-tools - [your task description]"

# Example
claude "go-cli-tools - analyze the current implementation"
```
...
def implement_go_cli_tools(input_data):
    """
    Implement go-cli-tools functionality.
