...
This guide provides comprehensive documentation for the **go-docker** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-docker - [your task description]"

# Example
claude "go-docker - analyze the current implementation"
```
...
def implement_go_docker(input_data):
    """
    Implement go-docker functionality.
