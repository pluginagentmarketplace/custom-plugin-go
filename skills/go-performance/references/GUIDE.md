...
This guide provides comprehensive documentation for the **go-performance** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-performance - [your task description]"

# Example
claude "go-performance - analyze the current implementation"
```
...
def implement_go_performance(input_data):
    """
    Implement go-performance functionality.
