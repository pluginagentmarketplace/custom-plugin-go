...
This guide provides comprehensive documentation for the **go-grpc** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-grpc - [your task description]"

# Example
claude "go-grpc - analyze the current implementation"
```
...
def implement_go_grpc(input_data):
    """
    Implement go-grpc functionality.
