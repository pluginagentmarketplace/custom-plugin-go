...
This guide provides comprehensive documentation for the **go-web-apis** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-web-apis - [your task description]"

# Example
claude "go-web-apis - analyze the current implementation"
```
...
def implement_go_web_apis(input_data):
    """
    Implement go-web-apis functionality.
