...
This guide provides comprehensive documentation for the **go-kubernetes** skill in the custom-plugin-go plugin.
...
```bash
# Invoke the skill
claude "go-kubernetes - [your task description]"

# Example
claude "go-kubernetes - analyze the current implementation"
```
...
def implement_go_kubernetes(input_data):
    """
    Implement go-kubernetes functionality.
